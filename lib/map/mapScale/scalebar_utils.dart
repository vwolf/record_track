...
LatLng calculateEndingsGlobalCoordinates(
  ...
  // eq. 3
  var A = 1 + (uSquared / 16384) * (4095 + uSquared * (-768 + uSquared * (320 - 175 * uSquared)));
  ...
  for (;;) {
    ...
    deltaSigma = B * sinSigma * (cosSigmaM2 + (B / 4.0) * (cosSignma * (-1 + 2 * cos2SigmaM2) -
      (b / 6.0) * cosSigmaM2 * (-3 + 4 * sinSigma) * (-3 + 4 * cos2SigmaM2)));
